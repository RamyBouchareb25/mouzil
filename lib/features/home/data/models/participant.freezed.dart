...
abstract class $ParticipantCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String firstName, String lastName, String phoneNumber, String? prizeId});
}
...
class _$ParticipantImpl with DiagnosticableTreeMixin implements _Participant {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Participant(firstName: $firstName, lastName: $lastName, phoneNumber: $phoneNumber, prizeId: $prizeId)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('prizeId', prizeId));
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, firstName, lastName, phoneNumber, prizeId);
...
abstract class _Participant implements Participant {
  const factory _Participant(
      ...
      required final String? prizeId}) = _$ParticipantImpl;
