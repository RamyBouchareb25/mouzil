...
mixin _$Participant {
  ...
  Prize get prize => throw _privateConstructorUsedError;
...
class _$ParticipantCopyWithImpl<$Res, $Val extends Participant>
  ...
  @pragma('vm:prefer-inline')
  $PrizeCopyWith<$Res> get prize {
    return $PrizeCopyWith<$Res>(_value.prize, (value) {
      return _then(_value.copyWith(prize: value) as $Val);
    });
  }
}
...
class _$ParticipantImpl with DiagnosticableTreeMixin implements _Participant {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Participant(firstName: $firstName, lastName: $lastName, phoneNumber: $phoneNumber, date: $date, prize: $prize)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, firstName, lastName, phoneNumber, date, prize);
...
abstract class _Participant implements Participant {
  const factory _Participant(
      ...
      required final Prize prize}) = _$ParticipantImpl;
